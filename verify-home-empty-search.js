...
assert.ok(html.includes('language-links.js?v=20260925-live22'),'homepage must cache-bust the current search guard, customer polish and affiliate readiness helper');
