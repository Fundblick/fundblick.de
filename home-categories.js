...
(function(root){
  ...
  function linkFor(category,count){const a=document.createElement('a');a.dataset.liveCategory='true';a.href='search.html?'+new URLSearchParams({q:category,lang:lang()}).toString();a.textContent=label(category);a.title=`${count} Produkt${count===1?'':'e'}`;a.dataset.catalogCategory=category;return a;}
